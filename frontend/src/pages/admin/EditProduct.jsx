...
export default function EditProduct() {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (
            ...
            // console.warn(fd.entries());

            // dispatch(updateProductAction({ name, price, stock, desc }, id))
            ...
            <Box sx={{ maxWidth: "100%", margin: "10% 25%" }}>
                ...
                <Stack spacing={3}>
                    <form onSubmit={formik.handleSubmit}>
                        ...
                        <br /> <br />
                        <Button fullWidth variant='contained' type='submit' color='success'>Add Product</Button>
                    </form>
                </Stack>
            </Box>
